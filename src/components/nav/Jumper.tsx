...
const sections = [
  {
    ...
    items: [
      ...
      { label: 'Selección de modo',     href: '/joven/modo',            description: 'Escudo vs Salvavidas' },
      { label: 'Chat Escudo (ANA)',     href: '/joven/chat',            description: 'Análisis de conversación' },
      { label: 'Chat Salvavidas',       href: '/joven/chat-salvavidas', description: 'Crisis activa paso a paso' },
      { label: 'Acciones inmediatas',   href: '/joven/acciones',        description: '4 pasos de protección' },
      { label: 'Reporte ANA',          href: '/joven/reporte',         description: 'PDF + envío a policía' },
      { label: 'Líneas de atención',   href: '/joven/lineas',          description: '4 líneas con guión' },
      { label: 'Análisis de riesgo',   href: '/joven/analisis',        description: 'RiskShape + progreso' },
      { label: 'Mapa temporal',         href: '/joven/mapa',            description: 'Línea de tiempo del caso' },
